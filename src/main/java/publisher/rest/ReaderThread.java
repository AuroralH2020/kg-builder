...
//      System.out.println("Configuration service running on " + "http://localhost:" + Publisher.CONFIG_PORT);
//	System.out.println("Publisher service running on " + "http://localhost:" + Publisher.PUBLISHER_PORT);
//
    }
  }
